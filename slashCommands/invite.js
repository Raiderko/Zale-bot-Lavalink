  ...
  options: [ 
    ...
    try {    
      if(user) {
        ...
        let button_public_invite = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.public)).setURL("https://discord.com/api/oauth2/authorize?client_id=907691017648603218&permissions=8&scope=bot%20applications.commands")
        let button_support_dc = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.server)).setURL("https://discord.gg/a7vNfSHngX")
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(`${user.username}`, "https://imgur.com/2BEcKBb.gif")],
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(`${client.user.username} `, "https://imgur.com/2BEcKBb.gif")],
          components: allbuttons
        });
      }
    } catch (e) {
